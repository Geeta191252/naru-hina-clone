class script(object):
    START_TXT = """<b>​​​<blockquote>ʜɪɪ {} 👋, 
ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴇᴅɪᴀ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ. ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇᴅ ᴀʟʟ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ. ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ .</blockquote></b>"""
...
<b><blockquote>╰─────────────────────⍟</blockquote></b>"""
    ...
    STATUS_TXT = """<b><blockquote>╭─[ ᴅᴀᴛᴀʙᴀsᴇ 1 ]──⍟</blockquote></b>
│
├⋟ ᴀʟʟ ᴜsᴇʀs ⋟ <code>{}</code>
├⋟ ᴀʟʟ ɢʀᴏᴜᴘs ⋟ <code>{}</code>
├⋟ ᴘʀᴇᴍɪᴜᴍ ᴜꜱᴇʀꜱ ⋟ <code>{}</code>
...
⚠️ <b>Limited Lifetime Slots!</b>

🚀 No Links   ⚡ Super Fast   🔓 All Features
📞 Priority Support 24/7

💳 <b>UPI:</b> <code>8504021912@slc</code>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @Hidden_Xman
...
• /details - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴇᴛᴛɪɴɢꜱ."""    
    ...
    SOURCE_TXT = """<b>ՏOᑌᖇᑕᗴ ᑕOᗪᗴ :</b> 👇\nThis Is Not a Open-Source Project. You Can Use It Freely, But Selling The Source Code Is Strictly Prohibited. Repo purchase for contact<blockquote><b>👉 @Hidden_Xman</b></blockquote>"""

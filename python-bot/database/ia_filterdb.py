...
async def check_db_size(silentdb):
    """Return Atlas-quota usage (dataSize + indexSize) in bytes.
    This matches the value MongoDB Atlas shows on the cluster page and
    what /stats reports, so the 450 MB switch threshold is consistent."""
